    ...
    <div class="fillcontain">
        ...
        <div class="table_container">
            <div style="margin-top: 15px;margin-bottom: 10px;display: flex;justify-content: flex-start">
                ...
                <div style="width: 10rem;margin-left: 2%">
                    <el-input v-model="txGroupId" placeholder="请输入事务组ID"></el-input>
                </div>
                <div style="margin-left: 2%">
...
<script>
    ...
    export default {
        ...
        created() {
            this.$http.post(this.baseUrl + '/recover/listAppName', {}).then(
                response => {
        ...
        methods: {
            ...
            updateRetryCount: function () {
                ...
                this.$http.post(this.baseUrl + '/recover/update', {
            ...
            query: function () {
                this.$http.post(this.baseUrl + '/recover/listPage', {
                    "pageParameter": {
                        "pageSize": this.paging.limit,
                    },
                    "applicationName": this.selected,
                    "retry": this.retryCount,
                    "txGroupId": this.txGroupId
                }).then(
                    response => {
                        if (response.body.code == 200 && response.body.data != null) {
            ...
            deleteAll: function () {
                ...
                this.$http.post(this.baseUrl + '/recover/batchRemove', {
                    "applicationName": this.selected,
                    "ids": groupIds
                }).then(
                    response => {
